...
// sockets
export const ADD_SOCKET_LIST = 'ADD_SOCKET_LIST';
export const REMOVE_SOCKET_LIST = 'REMOVE_SOCKET_LIST';
export const ADD_SOCKET_PEOPLE = 'ADD_SOCKET_PEOPLE';
export const REMOVE_SOCKET_PEOPLE = 'REMOVE_SOCKET_PEOPLE';
